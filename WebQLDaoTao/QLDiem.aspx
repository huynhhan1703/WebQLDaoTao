...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    ...
    <asp:GridView ID="gvKetQua" ShowFooter="true" DataKeyNames="id" runat="server"
        AutoGenerateColumns="false" CssClass="table table-bordered " Width="100%" OnSelectedIndexChanged="gvKetQua_SelectedIndexChanged1" HeaderStyle-BackColor="#0099ff">
        <Columns>
        ...
        <EmptyDataTemplate>
            <div class="alert alert-">Không có dữ liệu để hiển thị!</div>
        </EmptyDataTemplate>
